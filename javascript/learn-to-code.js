...
// var cat2 = 10;
// var cat3 = 1; 
// var cat3iDsabledHandicap = true;

// if ((cat1 > cat2 && cat1 > cat3) && !cat3iDsabledHandicap) {
//     console.log("Cat 1 is the cutest!");
// } else if ((cat2 > cat1 && cat2 > cat3) && !cat3iDsabledHandicap) {
//     console.log("Cat 2 is the cutest!");
// }else if ((cat3 > cat1 && cat3 > cat2) || cat3iDsabledHandicap) {
